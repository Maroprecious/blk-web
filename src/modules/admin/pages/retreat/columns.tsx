...
export const columns = (data?: any): ColumnDef<Participant>[] => {
  return [
    {
      accessorKey: "name",
      header: () => (
        <p className="font-arapey text-[#667085] font-light">
          Participant name
        </p>
      ),
      cell: ({ row }) => {
                ...
                <DialogHeader>
                  ...
                  <DialogDescription>
                    <p className="text-[#667085] mt-6">
                      Are you sure you want to remove this participant? You
                      can’t go back on this action.
                    </p>
                  </DialogDescription>
                </DialogHeader>
