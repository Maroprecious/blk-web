...
import Accordions from "@/shared/components/accordion/accordion";
...
export default function RetreatID() {
  ...
  console.log(data?.data?.hotel, "data?.data?.hotel");
  useEffect(() => {
    if (params.id) {
      refetch();
    }
    ...
    <PageLayout>
      {matches ? (
            ...
            <div>
              {active === 0 && (
                <div className="pt-6">
                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-[22px] font-amsterdam py-6 text-gray-900">
                      {data?.data?.name}
                    </p>
                  ...
                  <div className="flex w-[40%] gap-4 mt-4">
                    ...
                    <div className="flex items-center p-2 gap-[.3rem] justify-items-start bg-cream-300">
                      ...
                      <p className="text-clay-900 font-arapey text-[15px]">
                        ...
                        {`${
                          data?.data.participants.length < 2
                            ? "person"
                            : "people"
                        }`}
                      </p>
        ...
        <div className="mt-6 px-4 pb-20">
          <div className="w-full mx-auto h-[329px]">
            <div
              className="w-full h-full bg-cover bg-center bg-no-repeat"
              style={{
                backgroundImage: `url('${data?.data?.images[0]}')`,
          ...
          <Accordions
            faq={data?.data?.faq || []}
            items={data?.data?.hotel || []}
            setSelected={({
              name, address, image, rating
            }) => {
              setSelected({
                name,
                address,
          ...
          />
          <div className="w-full bg-[#fff] left-0 fixed bottom-0 z-[200]">
